var Formoid = function() {
    ...
    function $ajax(url, settings) {
        return new Promise(function(resolve, reject) {
            ...
            xhr.onload = function() {
                if (xhr.status !== 200) return reject(new Error("Incorrect server response."));
                resolve(xhr.responseText);
            };
            xhr.onerror = function() {
                var message = "Failed to query the server. ";
                if ("onLine" in navigator && !navigator.onLine) message += "No connection to the Internet.";
                else message += "Check the connection and try again.";
...
if (typeof bootstrap !== "undefined") {
    if (bootstrap.Tooltip.VERSION.startsWith(5)) //bs5
...
if (bootstrap) formModal = new bootstrap.Modal(formModalDOM);
...
formComponents.forEach(function(component) {
    ...
    form.addEventListener("submit", function(event) {
        ...
        function parseInput(input) {
            return new Promise(function(resolve, reject) {
                // valide email
                if (input.getAttribute("name") === "email" && !isValidEmail(input)) return reject(new Error("Form is not valid"));
...
//# sourceMappingURL=index.a96ac37f.js.map
