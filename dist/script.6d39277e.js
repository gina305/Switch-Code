...
(function () {
    ...
    function e(a) {
      b(a, "[data-bg-video]").forEach(function (a) {
        ...
        if (b) {
          ...
          } else if (n) e.style.backgroundImage = 'url("images/video-placeholder.jpg")', e.style.display = "block";else if (!n) {
            var r = function r() {
              var a = f.videoHeight,
                b = f.videoWidth,
                c = f.parentNode.clientHeight;
  ...
  if (!n && (0 < window.navigator.userAgent.indexOf("MSIE ") || navigator.userAgent.match(/Trident.*rv:11\./))) g(document).on("add.cards", function (a) {
    var b = a.target;
    b.classList.contains("mbr-fullscreen") && (a = function a() {
      b.style.height = "auto";
  ...
  m(function () {
    if (!n) {
      var a = function a(_a) {
          _a.target && ("VIDEO" == _a.target.tagName ? (_a.preventDefault(), _a.stopPropagation()) : b(_a.target));
        },
        b = function b(_b) {
          var c = _b.parents("section")[0].querySelector("iframe"),
            d = c.getAttribute("src");
          _b.parents("section").forEach(function (a) {
            a.style.zIndex = "5000";
          });
          if (d) {
          ...
          var h = _b.parents("section")[0],
            f = h.querySelector(h.querySelector("[data-modal]").getAttribute("data-modal"));
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","assets/theme/js/script.js"], null)
//# sourceMappingURL=/script.6d39277e.js.map