...
$jscomp.polyfill("Array.from", function(b) {
    return b ? b : function(b, d, q) {
        ...
        if ("function" == typeof p) {
            b = p.call(b);
            for(var u = 0; !(p = b.next()).done;)h.push(d.call(q, p.value, u++));
        } else for(p = b.length, u = 0; u < p; u++)h.push(d.call(q, b[u], u));
        return h;
    };
}, "es6", "es3");
...
$jscomp.findInternal = function(b, h, d) {
    ...
    for(var q = b.length, m = 0; m < q; m++){
        var p = b[m];
        if (h.call(d, p, m, b)) return {
            i: m,
            v: p
        };
    }
...
$jscomp.polyfill("String.prototype.startsWith", function(b) {
    return b ? b : function(b, d) {
        ...
        b += "";
        var m = h.length, p = b.length;
        d = Math.max(0, Math.min(d | 0, h.length));
        for(var u = 0; u < p && d < m;)if (h[d++] != b[u++]) return !1;
        return u >= p;
    };
}, "es6", "es3");
...
(function() {
    ...
    function y(a) {
        var c = a.getAttribute("id") + "-carousel", e = a.getAttribute("data-bs-version") && a.getAttribute("data-bs-version").startsWith("5");
    ...
    function E(a) {
        var c = a.querySelectorAll(".carousel-item").length, e = a.querySelector(".carousel-inner").getAttribute("data-visible");
        c < e && (e = c);
    ...
    var g, n, v = "function" == typeof jQuery;
    v && (g = jQuery);
    g ? n = g("html").hasClass("is-builder") : n = document.querySelector("html").classList.contains("is-builder");
    ...
    Element.prototype.footerReveal = function() {
        function a() {
            !d && c.offsetHeight <= window.outerHeight ? (c.style.zIndex = "-999", c.style.position = "fixed", c.style.bottom = "0", c.style.width = b.offsetWidth + "px", b.style.marginBottom = c.offsetHeight + "px") : (c.style.zIndex = "", c.style.position = "", c.style.bottom = "", c.style.width = "", b.style.marginBottom = "");
        }
    ...
    var H = function() {
        ...
        b.appendChild(a);
        var e = parseInt(window.innerHeight / 2, 10), d = parseInt((window.getComputedStyle ? getComputedStyle(a, null) : a.currentStyle).height, 10);
        b.removeChild(a);
        return d == e;
    }();
    m(function() {
        ...
        function e(a) {
            b(a, "[data-bg-video]").forEach(function(a) {
                ...
                if (b) {
                    var c = b.match(/(http:\/\/|https:\/\/|)?(player.|www.)?(vimeo\.com|youtu(be\.com|\.be|be\.googleapis\.com))\/(video\/|embed\/|watch\?v=|v\/)?([A-Za-z0-9._%-]*)(&\S+)?/), e = a.querySelector(".mbr-background-video-preview") || document.createElement("div");
                    ...
                    if (c && (/youtu\.?be/g.test(c[3]) || /vimeo/g.test(c[3]))) {
                        if (c && /youtu\.?be/g.test(c[3])) {
                            ...
                            l.onload = function() {
                                if (120 === (l.naturalWidth || l.width)) {
                                    ...
                                    switch(b){
                                        ...
                                        case "sddefault.jpg":
                                            ...
                                            break;
                                        default:
                                            n && (e.style.backgroundImage = 'url("images/no-video.jpg")', e.style.display = "block");
                                    }
                                ...
                                var f = document.createElement("div"), d = document.createElement("div"), r = document.createElement("div"), k = document.createElement("div");
                                ...
                                d = b._opts.width / b._opts.height;
                                k = Math.ceil(r / d);
                                k < f && (k = f, r = Math.ceil(k * d));
                                b.setSize(r, k);
                            };
                            l.setAttribute("src", b);
                        } else if (c && /vimeo/g.test(c[3])) {
                            ...
                            d.onreadystatechange = function() {
                                if (4 === this.readyState) {
                                    ...
                                    } else n && (e.style.backgroundImage = 'url("images/no-video.jpg")', e.style.display = "block");
                                }
                            };
                            d.send();
                            d = null;
                    ...
                    } else if (n) e.style.backgroundImage = 'url("images/video-placeholder.jpg")', e.style.display = "block";
                    else if (!n) {
                        var r = function() {
                            var a = f.videoHeight, b = f.videoWidth, c = f.parentNode.clientHeight;
                            f.style.height = (a < c ? c : a) + "px";
                            f.style.width = null;
                            f.clientWidth > b && (f.style.width = "100%", f.style.height = null);
                        };
                        ...
                        b = "";
                        a.querySelector(".mbr-fallback-image") && (b = window.getComputedStyle(a.querySelector(".mbr-fallback-image")).backgroundImage, b = b.match(/\((.*?)\)/)[1].replace(/('|")/g, ""), f.setAttribute("poster", b));
                        f.onloadeddata = function() {
                            r();
                        };
                        f.append(d);
                        a.childNodes[1].before(f);
        ...
        if ("undefined" !== typeof jarallax && !x()) {
            ...
            if (n) {
                ...
                g(document).on("changeParameter.cards", function(a, b, e, d) {
                    if ("bg" === b) switch(b = a.target, jarallax && jarallax(b, "destroy"), b.style.position = "", g(a.target).find(".mbr-background-video-preview").remove(), g(a.target).find(".mbr-background-video").remove(), d){
                        case "type":
        ...
        var k, l, C = 0, t = null, m = !x();
        window.addEventListener("scroll", function() {
            l && clearTimeout(l);
            var a = document.documentElement.scrollTop, b = a <= C || m;
            C = a;
            if (t) {
                var c = a > t.breakPoint;
                b ? c != t.fixed && (m ? (t.fixed = c, t.elm.classList.toggle("is-fixed")) : l = setTimeout(function() {
                    t.fixed = c;
        ...
        if (n) g(document).on("changeParameter.cards", function(a, b, c, d) {
            if ("bg" === b) switch(d){
                case "type":
        ...
        document.querySelectorAll(".cols-same-height .mbr-figure").forEach(function(a) {
            ...
            var c = a.querySelector("img"), e = a.parentNode, l = c.width, k = c.height;
    ...
    if (!n && (0 < window.navigator.userAgent.indexOf("MSIE ") || navigator.userAgent.match(/Trident.*rv:11\./))) g(document).on("add.cards", function(a) {
        var b = a.target;
    ...
    m(function() {
        if (!n) {
            var a = function(a) {
                ...
                if (d) {
                    if (-1 !== d.indexOf("youtu") && c.contentWindow.postMessage('{"event":"command","func":"playVideo","args":""}', "*"), -1 !== d.indexOf("vimeo")) {
                ...
                var h = b.parents("section")[0], f = h.querySelector(h.querySelector("[data-modal]").getAttribute("data-modal"));
                f.style.display = "table";
                f.addEventListener("click", function(b) {
                    "VIDEO" !== b.target.tagName && (d ? (-1 !== d.indexOf("youtu") && c.contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}', "*"), -1 !== d.indexOf("vimeo") && e.pause()) : (b = c.parentNode.querySelector("video")) && b.pause && b.pause(), f.style.display = "none", f.removeEventListener("click", a), h.style.zIndex = "0");
                });
            };
    ...
    if (!n) {
        ...
        var A = document.querySelectorAll(".dropdown-menu.show, .dropdown.open"), I = document.querySelectorAll(".dropdown.open");
    ...
    n || ("undefined" === typeof window.initClientPlugin && 0 != document.body.querySelectorAll(".clients").length && (window.initClientPlugin = !0, document.body.querySelectorAll(".clients").forEach(function(a) {
        ...
        y(a);
    })), "undefined" === typeof window.initSwitchArrowPlugin && (window.initSwitchArrowPlugin = !0, m(function() {
    ...
    if (n) g(document).on("add.cards changeParameter.cards", function(a, b) {
    ...
    if (n && v) g(document).on("add.cards", function(a) {
...
//# sourceMappingURL=index.b6dd9834.js.map
