...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"assets/dropdown/js/navbar-dropdown.js":[function(require,module,exports) {
...
(function () {
  function b(a) {
    "resize" === a.type && (document.body.classList.remove("navbar-dropdown-open"), document.querySelector(".navbar-dropdown").querySelector(".navbar-collapse").classList.remove("show"), document.querySelector(".navbar-dropdown").classList.remove("opened"), Array.from(document.querySelector(".navbar-dropdown").querySelectorAll('.navbar-toggler[aria-expanded="true"]')).forEach(function (b) {
      ...
      a && (a.classList.remove("in"), a.setAttribute("aria-expanded", "false"), b.setAttribute("aria-expanded", "false"));
    }));
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","assets/dropdown/js/navbar-dropdown.js"], null)
//# sourceMappingURL=/navbar-dropdown.4afa80f6.js.map